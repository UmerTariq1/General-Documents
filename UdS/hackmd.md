...
![written-on](https://img.shields.io/badge/last_updated_on-18_Dec_24-blue)

update: 18th dec 2024: Cusanus has had some severe management problems recently and its not advised anymore to take an apartment in that building. the biggest problem being that the kitchen is only on first floor and there is also emergency exit authority something something issue. better to avoid it or keep it as a very very last resort.
